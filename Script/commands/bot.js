...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "বট") || (event.body.toLowerCase() == "Bot")) {
     return api.sendMessage("bot🤖কমান্ড এড় নাই টাইপ করুন👉 botli", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Me") || (event.body.toLowerCase() == "sam")) {
     return api.sendMessage("SAME TO YOU ME😊 ", threadID);
   };

   if ((event.body.toLowerCase() == "🫦") || (event.body.toLowerCase() == "💋")) {
     return api.sendMessage("বেডা মানুষ কতো লুচ্চা, মাইয়া মানুষ দেখলেই কিস দে😾 ।", threadID);
   };

   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
     return api.sendMessage("GOOD MORNING Too দাত ব্রাশ করে খেয়ে নেও😚", threadID);
   };

   if ((event.body.toLowerCase() == "tor ball") || (event.body.toLowerCase() == "bal")) {
     return api.sendMessage("~  বাল বেশি বড় হলে কেটে ফেল এই নে বেলেট👉🔪🤖", threadID);
   };

  if ((event.body.toLowerCase() == "মারিয়া ") || (event.body.toLowerCase() == "Rana ke") || (event.body.toLowerCase() == "@রু্ঁপ্ঁ ন্ঁগ্ঁরে্ঁর্ঁ রা্ঁজ্ঁ ক্ঁন্যা্ঁ") || (event.body.toLowerCase() == "Mariya")) {
     return api.sendMessage("কিগো জান আমাকে ডাকছো, এইতো আমি বলো কি বলবা..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Rana ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 rana.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100000654976375\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:𝗥𝗮𝗻𝗮 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রানা আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন🤖🥰", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝗥𝗮𝗻𝗮 ッ❤️ তাকে সবাই বাবু নামে  চিনে🤙", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "botli cup") || (event.body.toLowerCase() == "চুপ কর") || (event.body.toLowerCase() == "bot chup kor")) {
     return api.sendMessage("আমার বস ছাড়া কারো কথা শুনার টাইম নাই,তুই চুপ থাক😾🔪", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sali tore cudi") || (event.body.toLowerCase() == "magi") || (event.body.toLowerCase() == "পুট মারি ") || (event.body.toLowerCase() == "sali")) {
     return api.sendMessage(" এই খানে ১৮+ কথা বলে নিষিদ্ধ 🔪😾🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@sk babu ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার জামাই  বট এর   আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "মারিয়া ") || (event.body.toLowerCase() == "arohi")) {
  ...
  if ((event.body.toLowerCase() == "@চুৃ্ঁদাৃ্ঁরৃ্ঁ রাৃ্ঁনিৃ্ঁ সাৃ্ঁ'মিৃ্ঁ'য়াৃ্ঁ ") || (event.body.toLowerCase() == "Samiya")) {
     return api.sendMessage("🥰-সামিয়া🌺 আমার বান্ধবী ' লাগে লুচ্ছি বেডা'রা দূরে থাক😠🥰⛏️", threadID);
   };

   if ((event.body.toLowerCase() == "Bot kiss de") || (event.body.toLowerCase() == "bot me")) {
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে ইনবক্সে ভিডিও কল দে .!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️আমি ফুল,তুমি কলি, চলো দুইজন ইনবক্সে পেম করি🐸💋😷", threadID);
   };

   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝗠𝗮𝗿𝗶𝘆𝗮 𝗯𝗼𝘁𝗹𝗶🤖", threadID);
   };

   if ((event.body.toLowerCase() == "বটলি বাচ্চা ") || (event.body.toLowerCase() == "Botli er bacca")) {
     return api.sendMessage("️তোমায় দেখলে মনে হয় তোমার বাচ্চা, আমার পেটে আম্মু, আম্মু কয়.!!🌚 ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "বিএফ") || (event.body.toLowerCase() == "bf")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি আমাকেও একটা বিএফ দে<🥺", threadID);
   };
   
   if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "😸") || (event.body.toLowerCase() == "😹")) {
     return api.sendMessage("ভাই তুই এত হাসিস না হাসলে তোরে মদনে মত লাগে..!🌚🤣", threadID);
   };

   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("যেই নারী অনিশ্চিত ভবিষ্যৎ জেনেও একটা ছেলের হাত ধরে আপন করে নেয়, সে নারী কখনোই মিথ্যা ভালোবাসতে পারে না …😊❤️‍🩹", threadID);
   };

   if ((event.body.toLowerCase() == "কেমন আছো") || (event.body.toLowerCase() == "কেমন আছেন") || (event.body.toLowerCase() == "Kmon acho") || (event.body.toLowerCase() == "bot kemon aso") || (event.body.toLowerCase() == "tmi kemon aso")) {
   ...
   if ((event.body.toLowerCase() == "bot i love you") || (event.body.toLowerCase() == "Love you bot") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you too")) {
     ...
     return api.sendMessage("কিরে তুই কি  কোন ছেলের সাথে চিপায় যাবি..!🌚🌶️🍆⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "পাগল নাকি") || (event.body.toLowerCase() == "pagol")) {
     return api.sendMessage("হুম ঝাং আমি তোমার প্রেমে  পাগলী<🥵", threadID);
   };

   if ((event.body.toLowerCase() == "ami bot") || (event.body.toLowerCase() == "botli koi")) {
     return api.sendMessage("হ্যা জান কেমন আছো..?☺️", threadID);
   };
  mess = "{name}"
